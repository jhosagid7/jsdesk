...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("soporte.jhonnypirela.dev".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("JSDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["soporte.jhonnypirela.dev"];
pub const RS_PUB_KEY: &str = "eI5U5mbVwyJ+7cdtaZa2fEs+PsDWPejoPCq9X6HDn9k=";
